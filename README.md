...
- **Parts table** — finished vs rough T×W×L (in), manual rough toggle, provenance pills (derived/manual rough + joinery counts), **Why?** explainer, **CSV export** (includes BF/LF columns).
